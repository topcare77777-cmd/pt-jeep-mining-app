        ...
        async function initPerformance() {
            try {
                ...
                if (isMounted) {
                    ...
                    const division = (profile?.role || 'HRD Dept').trim()
                        ...
                        if (allPerms && allPerms.length > 0) {
                            ...
                            const matched = allPerms.find((p) => {
                                ...
                                return (
                                    ...
                                    (cleanDiv.includes('performance') && target.includes('performance'))
                                )
                            })
                    ...
                    if (!isSuperAdmin && grantedKeys.length > 0 && !grantedKeys.includes('performance')) {
                        alert('Divisi Anda tidak memiliki hak akses ke modul Kinerja KPI.')
                        router.replace('/')
                        return
                    }
