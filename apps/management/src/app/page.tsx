...
export default function AdmDashboard() {
    ...
    useEffect(() => {
        async function initAdm() {
            try {
                ...
                // Tarik data dokumen riil dari tabel adm_documents
                ...
                console.error('Error init ADM:', err)
                setLoading(false)
            }
        }
    ...
    // Simpan Dokumen Baru ke Supabase
                    ...
                    <div className="bg-[#0a1625] border border-[#16273c] rounded-xl p-5 shadow-lg">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-xs font-bold text-slate-300 uppercase tracking-wider">
                                Log Surat & Berkas Masuk Lapangan (Real Supabase)
                            </h3>
                            <button
                                onClick={() => setShowModal(true)}
                                    ...
                                    {documents.length > 0 ? (
                                        ...
                                        <tr>
                                            <td colSpan={5} className="py-8 text-center text-slate-500 italic">
                                                Belum ada dokumen di tabel adm_documents. Klik "+ Dokumen Baru" untuk membuat agenda pertama.
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
